...
class ArticlesRVAdapter(private val listener: OnItemClickedListener): ListAdapter<Doc, ArticlesRVAdapter.ViewHolder>(DIFF_CALLBACK) {
    private lateinit var context: Context

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ArticlesRVAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ArticlesRVAdapter.ViewHolder, position: Int) {
